...
import com.babytree.apps.pregnancy.healthanalysis.widget.barchart.BarChart;
import com.babytree.apps.pregnancy.healthanalysis.widget.barchart.BarData;
import com.babytree.apps.pregnancy.healthanalysis.widget.barchart.BarDataSet;
import com.babytree.apps.pregnancy.healthanalysis.widget.barchart.BarEntry;
import com.babytree.apps.pregnancy.healthanalysis.widget.barchart.IBarDataSet;
import com.babytree.apps.pregnancy.healthanalysis.widget.barchart.Legend;
import com.babytree.apps.pregnancy.healthanalysis.widget.barchart.StackedValueFormatter;
...
//            });
            ...
            xLabels.setValueFormatter(new ValueFormatter() {
                ...
                public String getAxisLabel(float value, AxisBase axis, int i) {
                    ...
                    return xLabelValue.get((int) (value));
                }
            });
