...
public class Entry extends BaseEntry implements Parcelable {
    ...
    private float x = 0f;
    //是否显示爱爱图标
    public  boolean isVisibleLove = false ;
    //是否显示排卵日图标
    public  boolean isVisibleOvulation = false ;
    public int mColor;
    //填充爱爱分析图标的背景
     ...
     * @param isVisibleLove
     */
    public Entry(float x, float y, Drawable icon,int color,boolean isVisibleLove,boolean isVisibleOvulation,int fillDrawable) {
        super(y, icon);
        this.x = x;
        this.isVisibleLove = isVisibleLove;
        this.mColor = color;
        this.isVisibleOvulation = isVisibleOvulation;
        this.mFillDrawable = fillDrawable;
    }
    public Entry(float x, float y, Drawable icon,int color,boolean isVisibleLove) {
        super(y, icon);
        this.x = x;
        this.isVisibleLove = isVisibleLove;
        this.mColor = color;
