...
public class YAxisRenderer extends AxisRenderer {
    ...
    public YAxisRenderer(ViewPortHandler viewPortHandler, YAxis yAxis, Transformer trans, int type) {
    ...
    protected void drawYLabels(Canvas c, float fixedPosition, float[] positions, float offset) {
        ...
        if(mType ==BAR_CHART) {
            c.drawText("天", fixedPosition, mViewPortHandler.contentTop() + Utils.convertDpToPixel(5), mAxisLabelPaint);
        }else if(mType==LINE_CHART) {
            c.drawText("℃", fixedPosition, mViewPortHandler.contentTop(), mAxisLabelPaint);
        } else if(mType==LOVE_CHART) {
            c.drawText("怀孕", fixedPosition, mViewPortHandler.contentTop(), mAxisLabelPaint);
            c.drawText("几率", fixedPosition, mViewPortHandler.contentTop()+Utils.convertDpToPixel(12), mAxisLabelPaint);
        }
    }
