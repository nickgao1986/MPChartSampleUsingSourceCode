...
public class ViewPortHandler {
     ...
     * 内容距画布距离
     */
    public int marginRightRect;
    public int marginTopRect;
    /**
    ...
    public void setChartDimens(float width, float height) {
        ...
        mChartHeight = height-Utils.convertDpToPixel(marginTopRect);
        mChartWidth = width- Utils.convertDpToPixel(marginRightRect);
