...
import com.babytree.apps.pregnancy.healthanalysis.widget.barchart.YAxis.AxisDependency;
...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends
    ...
    public static final  int  LOVE_CHART = 2;

    protected XAxisRenderer mXAxisRenderer;
    protected int type; //0 bar chart ,1 line chart, 2 love chart
    ...
    protected void init() {
        ...
        mAxisRendererLeft = new YAxisRenderer(mViewPortHandler, mAxisLeft, mLeftAxisTransformer,type);
        mAxisRendererRight = new YAxisRenderer(mViewPortHandler, mAxisRight, mRightAxisTransformer,type);

        mXAxisRenderer = new XAxisRenderer(mViewPortHandler, mXAxis, mLeftAxisTransformer,type);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mXAxis.isDrawGridLinesBehindDataEnabled()&&type==LINE_CHART)
...
//        mAxisRendererRight.renderAxisLabels(canvas);
    ...
    public void notifyDataSetChanged() {
        ...
        if (mLegend != null&&mLegendRenderer!=null){
