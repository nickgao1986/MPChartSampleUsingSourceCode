...
public class LegendRenderer extends Renderer {
    ...
    private static final int INT = 80;
    /**
    ...
    public void renderLegend(Canvas c) {
        ...
        float yoffset = mLegend.getYOffset()-5;
        ...
        switch (horizontalAlignment) {
            ...
            case CENTER:
                ...
                if(mLegend.getLayout()) {
                    originPosX = originPosX * 2;
                }
                break;
        }
            ...
            case VERTICAL: {
                ...
                for (int i = 0; i < entries.length; i++) {
                    ...
                    if (drawingForm) {
                        ...
                        drawForm(c, posX, posY + formYOffset+ INT, e, mLegend);
                    ...
                    if (e.label != null) {
                        ...
                        if (!wasStacked) {
                            drawLabel(c, posX+100, posY + labelLineHeight+80, e.label);
                        } else {
                            posY += labelLineHeight + labelLineSpacing;
                            drawLabel(c, posX, posY + labelLineHeight, e.label);
                        }
...
//                c.drawRect(x, y - half, x + formSize, y + half, mLegendFormPaint);
                RectF oval3 = new RectF(x+100, y - half, x + formSize+100,y + half);// 设置个新的长方形
                c.drawRoundRect(oval3, 6, 6, mLegendFormPaint);
                break;
